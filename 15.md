...
As an example, install and run the _neofetch_ utility. This is in the standard repositories, but _neofetch -V_ will show that it is version 3.4.0. If for some reason you wanted to be have the very latest version of this at all times, you could install the developer's official Neofetch PPA to your software sources by:
