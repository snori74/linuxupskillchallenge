...
Setting this up to connect with a password is fairly intuitive, but there are a couple of steps required to use the keypair provide by AWS, as outlined in:
