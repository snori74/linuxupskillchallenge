...
Setting this up to connect with a password is fairly intuitive, but you do need to convert the format of the keypair provided by AWS, as outlined in:
...
The first time you connect to your server, you may receive a warning that you're connecting to a new server - and be asked if you wish to "cache the host key". Do this. Now, if you get a warning in future connections it means that either: (a) you are being fooled into connecting to a different machine or (b) someone may be trying a "man in the middle" attack.
...
* ["SSH Tunneling"] (https://linuxize.com/post/how-to-setup-passwordless-ssh-login/)
* ["Password-less SSH login"] (https://linuxize.com/post/how-to-setup-ssh-tunneling/)
