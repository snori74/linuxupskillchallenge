...
Scripts are just simple text files, but if you set the "execute" permissions on them then then the system will look for a special line starting with the two characters “#” and “!” - referred to as the "shebang" (or "crunchbang") at the top of the file. 
