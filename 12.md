...
On an Ubuntu system the first user created (in your case _ubuntu_), should be a member ofthe groups: _ubuntu_, _sudo_ and _adm_ - and if you list the _/var/log_ folder you'll see your membership of the _adm_ group is why you can use _less_ to read and view the contents of _/var/log/auth.log_
