...
The "normal mode" is used to input commands, and the "insert mode" is used for writing text. This last mode is vim's equivalent to a regular text editor's default behaviour, like the previously seen `nano`.
