...
This is the way that your server has been set-up, with your “ordinary” login given the ability to run any root-only command  - but only if you precede it with *sudo*. Generally this will ask you to re-confirm your identity with your password -
