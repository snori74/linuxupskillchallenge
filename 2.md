...
* you can make a new  folder/directory with the _mkdir_ command, so move to your home directory, type _pwd_ to check that you are indeed in the correct place, and then create a directory, for example to create one called "feedback", simply type _mkdir test_. Now use the _ls_ command to see the result.
...
* ...but also ensure you’ve created the new directory *feedback* in your home folder ( e.g _/home/<your user>/feedback_) - we’ll be using this in the next steps.
