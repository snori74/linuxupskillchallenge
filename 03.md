...
* Use the `uptime` command to confirm that your server did actually fully restart. It will take about a minute for the server to restart after which you can ssh again into it.
