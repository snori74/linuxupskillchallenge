...
* In */etc/apache2/apache.conf* there's the line:
    
    IncludeOptional conf-enabled/*.conf
    
This tells Apache to that the *.conf files in the subdirectory *conf-enabled* should be merged in with those from */etc/apache2/apache2.conf* at load. This approach of lots of small specific config files is common. 
